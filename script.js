const id = '0b43d40e3aaf1972fb8f7947b8e44d5e13b1f880a4d556eab94f794069cbb08e';
    ...
    for (let key in collectionsResult) {
        ...
        collectionItemContainer.setAttribute('data-collection',collectionsId);
    ...
    collections1.open("GET", "https://api.unsplash.com/search/collections?query=" + collectionsItems + "&client_id=" + id, false);
